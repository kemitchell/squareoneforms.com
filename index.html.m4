...
<main role=main>
  ...
  <section>
    ...
    <ol class=steps>
      <li><a download="Square One Offer Letter.rtf" href=offer-letter/1e1u.rtf>Download the offer letter template</a> and fill out all the blanks marked with {curly braces}, then sign at the bottom under “employer.”</li>
      <li><a download="Square One Employment Terms.pdf" href=employee/1e1u.pdf>Download the employment terms.</a></li>
  ...
  <section>
    ...
    <ol class=steps>
      ...
      <li><a download="Square One Statement of Work Template.rtf" href=statement-of-work/1e1u.rtf>Download the statement of work template</a> and fill out all the blanks marked with {curly braces}, then sign at the bottom under “client.”</li>
  ...
  <section>
    ...
    <p>Like others who were able to keep working during the pandemic, even as Americans lost work in record numbers, we felt a need to do what we could for those who weren’t so lucky. Part of that is helping companies who can rehire do so. Uncertainty and costs around basic legal terms shouldn’t slow them down.</p>
